                                    ...
                                    >
                                        <View style={{ flexDirection: 'row' }}>
                                            ...
                                            <TouchableOpacity
                                                ...
                                                onPress={() => Navigation.navigate('CoachAiDrivenPlayerSearch', { teamId: teamId, challengeId: challengeId })}>
                                        ...
                                        <FlatList
                                            ...
                                            renderItem={(item) =>
                                                <TouchableOpacity onPress={() => {
                                                    ...
                                                    Navigation.navigate('CoachAiDrivenPlayerDetailsStatSubmission',
                                                        {
                                                            submissionId:item.item.submissionId
                                                        })

                                                    : typeOfChallenge == "QUESTION" ?
                                                        Navigation.navigate('CoachAiDrivenPlayerDetailsQuestionSubmission',
                                                            {
                                                                submissionId:item.item.submissionId
                                                            })
                                                        :
                                                        Navigation.navigate('CoachAiDrivenPlayerDetailsVideoSubmission',
                                                            {
                                                                submissionId:item.item.submissionId
                                                            })
