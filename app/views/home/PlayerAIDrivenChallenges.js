...
const PlayerAIDrivenChallenge = (props) => {
    ...
    useEffect(() => {
        ...
        getObject('UserId').then((obj) => {
            ...
            console.log("eysa",obj)

            props.dispatch(listOfPlayers(obj, (res, data) => {
                if (res) {
                    setLoading(false)
                ...
                <KeyboardAvoidingView keyboardVerticalOffset={45} style={{ flex: 1, }}
                    ...
                    <View>
                        ...
                        {loading == false && teamId != undefined ?
                            <ScrollView bounces={false} style={{marginBottom:wide*0.3}}>
...
export default connect(mapStateToProps)(PlayerAIDrivenChallenge);
