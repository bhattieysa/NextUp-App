...
class TrainerSeeMore extends Component {
                    ...
                    <View style={{ flex: 1, backgroundColor: Colors.base }} >
                        ...
                        <View  >
                            <View style={{ marginTop: wide * 0.03 }}>
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <View style={{ marginTop: wide * 0.06, paddingLeft: 15 }}>
                                        <Text style={{
                                            color: Colors.light, fontSize: 26, fontFamily: Fonts.Bold,
                                            marginLeft: 5
                                        }}>Lorem Ipsum</Text>
                                        <Text style={{
                                            ...
                                            marginLeft: 5, marginVertical: wide * 0.05,
                                        }}>
                                            Experience - 7 years
                                    </Text>
                                        <Text style={{
                            ...
                            <View style={{ alignItems: 'center', justifyContent: 'center', width: wide * 0.23, marginLeft: 18, marginTop: 6 }}>
                                <AirbnbRating
                        ...
                        <View style={{ flex: 1 }}>
                            <TouchableOpacity onPress={() => { }} style={{
                                position: 'absolute', right: 10, top: wide * 0.06
                            }}>
                                <Image style={{
...
export default connect(mapStateToProps)(TrainerSeeMore);
