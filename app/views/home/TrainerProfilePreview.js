...
class TrainerProfilePreview extends Component {
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity onPress={() => { }} style={{
                                    ...
                                    <Image style={{
                                        ...
                                        width: 30, height: 30,
                                    }} resizeMode={'contain'} source={require('../../Images/forward_ico.png')} />
                                </TouchableOpacity>
...
Navigation.navigate('TrainerPlan')
                                }}>
                                <Text style={{
...
export default connect(mapStateToProps)(TrainerProfilePreview);
