...
import {
    assignedSeeAllChallenges, suggestedSeeAllChallenges
} from '../../actions/home';
import { getObject } from '../../middleware';



const PlayerAiDrivenAllChallenge = (props) => {
    ...
    useEffect(() => {
        ...
        getObject('UserId').then((obj) => {
            if (name == "assigned") {
                props.dispatch(assignedSeeAllChallenges(teamId, obj, (result, response) => {
                ...
                props.dispatch(suggestedSeeAllChallenges(teamId, obj, (result, response) => {
...
export default connect(mapStateToProps)(PlayerAiDrivenAllChallenge);
