...
const AIDrivenChallenges = (props) => {
    ...
    useEffect(() => {
        ...
        getObject('UserId').then((obj) => {
            props.dispatch(listAIDrivenChallenges(props.teamId, obj, (result, response) => {
                        ...
                        <View>
                            <View style={{ flexDirection: 'row', marginTop: wide * 0.03 }}>
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity onPress={() => Navigation.navigate('PlayerAIDrivenAllChallenge', { name: "assigned", teamId: props.teamId,   typeOfSubscription:"CHALLENGE", })}>
                                        <Text style={{
                                            color: Colors.btnBg,
                                            fontWeight: '700',
                                            fontSize: 14,
                                ...
                                renderItem={(item) =>
                                    <TouchableOpacity onPress={() => {
                                        ...
                                        <ImageBackground
                                            ...
                                            imageStyle={{ borderRadius: wide * 0.04 }}
                        ...
                        <View>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: wide * 0.1 }}>
                                ...
                                <View style={{
                                    ...
                                    <TouchableOpacity onPress={() => Navigation.navigate('PlayerAIDrivenAllChallenge', { name: 'suggested', teamId: props.teamId,   typeOfSubscription:"CHALLENGE", })}>
                                        <Text style={{
                                            color: Colors.btnBg,
                                            fontWeight: '700',
                                            fontSize: 14,
                            ...
                            <FlatList
                                ...
                                console.log("id",item.item)
                                            ...
                                            item.item.typeOfChallenge == "STATS" ?
                                                Navigation.navigate('PlayerAiDrivenStatsChallengeSuggested',
                                                    {
                                                        name: "suggested",
                                                        teamId: props.teamId,
                                                        challengeId: item.item.challengeId,
                                                ...
                                                : item.item.typeOfChallenge == "QUESTION" ?
                                                    Navigation.navigate('PlayerAiDrivenQuestionChallengeSuggested',
                                                        {
                                                            name: "suggested",
                                                            teamId: props.teamId,
                                                            challengeId: item.item.challengeId,
                                                    ...
                                                    :
                                                    Navigation.navigate('PlayerAiDrivenVideoChallengeSuggested',
                                                        {
                                                            name: "suggested",
                                                            teamId: props.teamId,
                                                            challengeId: item.item.challengeId,
