...
import { View, TouchableOpacity, Text, SafeAreaView, Image, key, KeyboardAvoidingView, ScrollView, TextInput, Platform, Dimensions, Alert, StatusBar } from 'react-native';
import {
  Layout,
  Colors,
  Fonts,
  ...
  render() {
    ...
    return (
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: Colors.base }}>
        ...
        {
          this.state.loading == true ? <AppLoader visible={this.state.loading} />
            ...
            >
              ...
              <View style={{
                ...
                <View style={{ marginTop: wide * 0.25, }}>
                  <TouchableOpacity
                    key={true}
                    style={{
                      ...
                      // this.actionContinue()
                      Navigation.navigate("Pro", { type: params.type })
                    }}>
                    <Text style={{
