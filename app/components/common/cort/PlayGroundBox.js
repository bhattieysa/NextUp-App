    ...
    return (
        ...
        >
            ...
            <TouchableOpacityG onPress={props.onPressShapeFour}>
                <Path fill={props.shapeFourBGColor} d="M125 0H233V134H125z" />
            </TouchableOpacityG>

            {/* shape left curve */}
            <TouchableOpacityG onPress={props.onPressShapeLeftCurve}>
                <Path
            ...
            {/* shape right curve */}
            <TouchableOpacityG onPress={props.onPressShapeRightCurve}>
                <Path
            ...
            {/* shape left curve 2 */}
            <TouchableOpacityG onPress={props.onPressShapeLeftCurve2}>
                <Path
            ...
            {/* shape right curve 2 */}
            <TouchableOpacityG onPress={props.onPressShapeRightCurve2}>
                <Path
            ...
            <TouchableOpacityG onPress={props.onPressShapeCenterCircleHolder}>
                <Path
            ...
            {/* shape center circle */}
            <TouchableOpacityG onPress={props.onPressShapeCenterCircle}>
                <Path
            ...
            <TouchableOpacityG onPress={props.onPressShapeHolderLeft}>
                <Path
            ...
            <G clipPath="url(#clip0_18_1977)">
                {/* shape holder zero */}
                <TouchableOpacityG onPress={props.onPressShapeZero}>
                    <Path fill={props.shapeZeroBGColor} d="M0 0.581177H31.9643V101.704177H0z" />
                </TouchableOpacityG>
                <Path
            ...
            <TouchableOpacityG onPress={props.onPressShapeRightHTop}>
                <Path fill={props.shapeRightHTopBGColor} d="M230 0H326V50H230z" />
            </TouchableOpacityG>
            <G clipPath="url(#clip1_18_1977)">

                {/* shape seven - right verticle top */}
                <TouchableOpacityG onPress={props.onPressShapeRightVTop}>
                    <Path
