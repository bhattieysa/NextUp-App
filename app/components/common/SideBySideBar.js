        ...
        for (const key in obj) {
          ...
          content1.push(<View style={{
            ...
            <View style={{
              ...
              {leftVal !== undefined && leftVal > 0 ?
                <View style={{
                  width: leftVal >= midVal ? leftVal > 90 ? `${90}%` : `${30 + parseFloat(leftVal)}%`
            ...
            <View style={{
              ...
              {rightVal !== undefined && rightVal > 0 ?
                <View style={{
                  width: rightVal >= midVal ? rightVal > 90 ? `${90}%` : `${30 + parseFloat(rightVal)}%`
            ...
            if (!leftObj.hasOwnProperty(key)) {
              content1.push(<View style={{
                ...
                <View style={{
                  ...
                  {leftVal !== undefined && leftVal > 0 ?
                    <View style={{
                      width: leftVal >= midVal ? leftVal > 90 ? `${90}` : `${30 + parseFloat(leftVal)}%` : `${30 - parseFloat(leftVal)}%`,
                      backgroundColor: Colors.compareBar,
                      height: 12,
                      maxWidth: '90%'
                    }}></View>
                ...
                <View style={{
                  ...
                  {rightVal !== undefined && rightVal > 0 ?
                    <View style={{
                      width: rightVal >= midVal ? rightVal > 90 ? `${90}%` : `${30 + parseFloat(rightVal)}%` : `${30 - parseFloat(rightVal)}%`,
                      backgroundColor: Colors.compareRightBar, height: 12,
                      maxWidth: '90%'
                    }}></View>
                    :
